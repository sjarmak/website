...
These authors asked. 627b, then repeated the whole thing on Work Arena, which is enterprise knowledge work tasks, not just simple web navigation. And in aggregate success rate, the bear actor came out even or ahead. Now they're careful, the skills they're using, and the skills they're using, and the skills they're using, and the workflow memory did help in specific domains.
