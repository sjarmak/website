...
[`before/phaseE_workflow.js`](before/phaseE_workflow.js). Its SHA-256 matches
the original file recorded in [`before/provenance.json`](before/provenance.json).
...
[`podcast_preset.py`](src/durable_research/podcast_preset.py). All ten original
...
[`podcast_prompts.py`](src/durable_research/podcast_prompts.py).

The Workflow in
[`podcast_workflow.py`](src/durable_research/podcast_workflow.py) retains the
...
[`podcast_activities.py`](src/durable_research/podcast_activities.py) contains
five Activities:
...
[`podcast_worker.py`](src/durable_research/podcast_worker.py) connects to the
...
[Multi-Agent Orchestration review](after/fixture-products/reviews/mas-literature-review.md),
[Code Retrieval review](after/fixture-products/reviews/code-literature-review.md),
or [manifest](after/fixture-products/manifest.json). The fixture outputs are
...
[`run-durable-research`](skills/run-durable-research/SKILL.md), a
