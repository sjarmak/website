...
One neutral source produces a native config for each agent, with agent-specific pieces scoped to the agents that need them. Everything is pre-rendered and committed, no build step before use.
