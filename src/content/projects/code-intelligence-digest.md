...
A focused app that pulls from Inoreader feeds across categories (newsletters, podcasts, tech articles, and more) and ranks items with a hybrid of LLM relevance, BM25, and recency to produce a readable digest of what's happening in code intelligence and agents.
