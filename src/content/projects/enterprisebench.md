...
The gap is stated in the repo: the calibration stratum of easy tasks where MCP should show no advantage sits at roughly half its 15% target, and until it is backfilled, every headline delta carries an asterisk. When MCP-mode runs score higher, the open question is how much is the tool and how much is a corpus shaped to favor it.
