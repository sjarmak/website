...
The evidence is uneven. Four items support the chapter’s two entries: two explorer-class and two literature-class. Only one, the fault-recovery benchmark, is a strong study. No strong study supports the trace argument. I therefore treat typed traces as an instrumentation design supported by demonstrations and a specification, and prescribe measurement rather than a universal recovery threshold.
