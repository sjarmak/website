...
- Directional evidence: Liu, C., et al. (2024), "A Survey of Source Code Search: A 3-Dimensional Perspective," *ACM Transactions on Software Engineering and Methodology*, [DOI:10.1145/3656341](https://doi.org/10.1145/3656341). The survey separates query, code, and matching components; transfer to repository agents remains directional.
