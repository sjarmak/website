...
The evidence base for this chapter is thin. Six items support its three design entries. Only two are strong, and five are explorer-class syntheses rather than controlled experiments. The storage recommendation has no strong evidence item and remains contested among practitioners.
