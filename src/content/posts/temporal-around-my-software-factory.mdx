---
title: "I put Temporal around my software factory. Here's what it fixed, and what it didn't."
date: 2026-08-06
description: "A durable work record is not the same thing as a durable procedure: what adding Temporal around a fleet of coding agents fixed, what it cost, and what it still has not proven."
tags: [agents, orchestration, durable-execution, reliability, temporal]
---

import CanaryFigure from "../../components/temporal-agent-orchestration/CanaryFigure.astro";
import ConceptFigure from "../../components/temporal-agent-orchestration/ConceptFigure.astro";
import ConspiracyFigure from "../../components/temporal-agent-orchestration/ConspiracyFigure.astro";
import OpeningFigure from "../../components/temporal-agent-orchestration/OpeningFigure.astro";
import WorkshopFigure from "../../components/temporal-agent-orchestration/WorkshopFigure.astro";
...
**Going deeper.** The [full annotated version](/temporal-agent-orchestration/article) has the recordings and the evidence bundle, and the [annotated source reader](/temporal-agent-orchestration/code) renders every before and after file. [Engineering Reliable Coding Agents](/books/engineering-reliable-coding-agents/) is the guidebook this is a field report from.
