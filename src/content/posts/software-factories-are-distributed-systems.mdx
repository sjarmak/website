...
What autonomous agents change are the characteristics of the worker.
...
There's real scale behind this: across 1,960 open-source Java projects, 3.2 percent of GitHub Actions builds got rerun, and 67.73 percent of those reruns were flaky ([Ge and Zhang 2026](https://arxiv.org/abs/2602.02307)). Build results and code correctness are two different signals, and a factory that treats them as one either retries good changes forever or ships on a pass that proved less than it assumed.
...
Coding agents have a new place in a much older systems problem. A software factory schedules more than CPU and memory; it schedules authority over mutable code, repository state, dependencies between changes, scarce review attention, and work that sits half-finished for hours or days.
