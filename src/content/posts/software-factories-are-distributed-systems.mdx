...
Mixing them up is where things break, and the mistake has one shape. One layer produces evidence that another layer accepts as authoritative. A running process doesn't prove the work is still assigned to it. A completed procedure doesn't prove its branch ever landed. A closed work item doesn't prove the result went anywhere at all.
