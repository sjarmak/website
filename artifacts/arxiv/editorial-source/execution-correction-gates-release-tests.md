...
Support for the repeated-trial metric comes from one source. τ-bench, from Yao et al. ([2024](https://arxiv.org/abs/2406.12045)), evaluates interactive, multi-turn tool use with executable oracles across repeated trials and introduces \(\mathrm{pass}^{k}\) as a reliability measure.
