...
\begin{figure}[htbp]
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Argument map for the reliability dependency chain: measurement, grading, containment and recovery, retrieval and context, review and accountability, and allocation and cost. Each layer supplies the evidence boundary on which the next relies.}]{figures/dependency-chain.pdf}}
