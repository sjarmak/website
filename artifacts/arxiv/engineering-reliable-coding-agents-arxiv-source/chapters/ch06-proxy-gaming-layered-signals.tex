...
\section{Layer signals beyond a single proxy}\label{layer-signals-beyond-a-single-proxy}
...
\section{Monitor proxy-true divergence}\label{monitor-proxy-true-divergence}
...
\section{Monitor reasoning without training pressure}\label{monitor-reasoning-without-training-pressure}
