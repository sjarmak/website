...
\hypertarget{move-from-prompt-changes-to-structural-repair-only-after-persistence}{%
...
\hypertarget{require-fan-out-to-beat-the-live-single-agent-baseline}{%
...
\hypertarget{choose-topology-by-task-shape-and-fault-propagation}{%
...
\hypertarget{dispatch-only-work-whose-dependencies-are-satisfied}{%
...
\hypertarget{promote-topology-from-a-topology-specific-record}{%
\section{Promote topology from a topology-specific record}\label{promote-topology-from-a-topology-specific-record}}
