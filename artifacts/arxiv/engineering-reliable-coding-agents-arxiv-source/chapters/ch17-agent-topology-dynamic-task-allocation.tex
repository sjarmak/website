...
\section{Select one persistent failure class}\label{select-one-persistent-failure-class}
...
\section{Draw the current causal path}\label{draw-the-current-causal-path}
...
\section{Preserve the live single-agent baseline}\label{preserve-the-live-single-agent-baseline}
...
\section{Specify one structural treatment}\label{specify-one-structural-treatment}
...
\section{Record the promotion rule before execution}\label{record-the-promotion-rule-before-execution}
...
\section{Inject a representative fault}\label{inject-a-representative-fault}
...
\section{Run paired repeated trials}\label{run-paired-repeated-trials}
...
\section{Promote, retain, or redesign}\label{promote-retain-or-redesign}
