...
\section{Derive the failure taxonomy from your own traces}\label{derive-the-failure-taxonomy-from-your-own-traces}
...
\section{Keep humans in failure attribution}\label{keep-humans-in-failure-attribution}
...
\section{Design traces for human audit}\label{design-traces-for-human-audit}
