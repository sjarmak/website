...
\hypertarget{define-the-allocation-decision-before-choosing-the-algorithm}{%
...
\hypertarget{recompute-from-current-state-and-stop-solving-on-time}{%
...
\hypertarget{route-to-the-cheapest-worker-predicted-to-meet-the-requirement}{%
...
\hypertarget{replay-identical-arrivals-before-changing-allocation-policy}{%
...
\hypertarget{instrument-decisions-before-optimizing-them}{%
