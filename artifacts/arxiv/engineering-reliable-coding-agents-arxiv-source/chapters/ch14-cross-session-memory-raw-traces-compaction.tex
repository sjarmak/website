...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Across app, office, and question-answering agents, removing distractions cuts peak tokens by 26\% to 54\% and raises small-model success by up to 46\%; no coding-agent benchmark supports extrapolating either effect to coding agents.}]{figures/ch14-compaction-tokens.pdf}}
...
\section{Preserve raw traces and distill separately}\label{preserve-raw-traces-and-distill-separately}
...
\section{Use a light store by default}\label{use-a-light-store-by-default}
...
\section{Optimize compaction from failures}\label{optimize-compaction-from-failures}
...
\section{Companion-catalog records named inline}\label{companion-catalog-records-named-inline}
