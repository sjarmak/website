...
\tightlist
\item
  OpenAI, ``Why we no longer evaluate SWE-bench Verified,'' 2026-02-20, \url{https://openai.com/index/why-we-no-longer-evaluate-swe-bench-verified}. {[}Corroborating evidence{]}
\item
...
\section{Measure public-score inflation with matched controls}\label{measure-public-score-inflation-with-matched-controls}
...
\section{Evaluate on post-cutoff tasks}\label{evaluate-on-post-cutoff-tasks}
...
\section{Strengthen test oracles before adjudication}\label{strengthen-test-oracles-before-adjudication}
...
\section{Benchmark on your own workload}\label{benchmark-on-your-own-workload}
...
\item
  swyx (2026), long-horizon evaluation account, X, 2026-01-14, \url{https://x.com/swyx/status/2011344788486774942}. {[}Corroborating case{]}
\item
