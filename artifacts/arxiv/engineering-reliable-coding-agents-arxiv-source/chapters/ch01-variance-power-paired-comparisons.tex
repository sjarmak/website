...
\section{Never report a single run}\label{never-report-a-single-run}
...
\section{Analyze statistical power before running}\label{analyze-statistical-power-before-running}
...
\section{Use paired tests matched to the metric}\label{use-paired-tests-matched-to-the-metric}
