\chapter{Baselines, ablations, and cost-accuracy tradeoffs}\label{baselines-ablations-and-cost-accuracy-tradeoffs}
...
\subsection{Run ablation controls}\label{run-ablation-controls}

\begin{itemize}
\tightlist
\item
  explorer/strong: \emph{SkillEvolBench} (Lei et al.~2026, arXiv:2605.24117), agentic-memory explorer synthesis covering no-skill and raw-trajectory controls, coverage matching, one-factor sweeps, and the writer information-flow pitfall.
\item
...
\item
  explorer/directional: \emph{TIAP} (arXiv:2605.24060), direction only; no figure carried.
\item
  explorer/directional: \emph{MemConflict} (arXiv:2605.20926), direction only; no figure carried.
\end{itemize}

\subsection{Report cost-accuracy tradeoffs}\label{report-cost-accuracy-tradeoffs}

\begin{itemize}
\tightlist
\item
  lit/directional: Kapoor, Stroebl, Siegel, Nadgir, and Narayanan (2024), \emph{AI Agents That Matter}, arXiv:2407.01502, a re-evaluation study.
\item
