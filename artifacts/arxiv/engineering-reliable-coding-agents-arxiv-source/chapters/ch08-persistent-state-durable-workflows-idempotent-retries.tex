...
The integration boundary often costs more than the workflow definition. My durable media integration, another \textbf{unverified working artifact}, required 15 commits across 45 files and added 11,662 lines, including 4,665 test lines. The workflow definition accounted for only a small part of the change. Most of the work established clean payloads, stable execution identities, idempotent external requests, injected-failure gates, and reconciliation with durable storage. These counts describe one system and support no industry-wide cost estimate.
...
\item
  Strong evidence: Jacob Meyers and Rob Zienert (2025). ``How Temporal Powers Reliable Cloud Operations at Netflix'', \href{https://netflixtechblog.com/how-temporal-powers-reliable-cloud-operations-at-netflix-73c69ccb5953}{Netflix TechBlog}, 2025-12-15.
\item
