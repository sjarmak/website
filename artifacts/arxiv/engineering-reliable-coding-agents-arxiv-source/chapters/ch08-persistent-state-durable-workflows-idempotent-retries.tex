...
\section{Make agent state a first-class persistent artifact}\label{make-agent-state-a-first-class-persistent-artifact}
...
\section{Use a durable workflow engine}\label{use-a-durable-workflow-engine}
...
\section{Make retried steps idempotent}\label{make-retried-steps-idempotent}
