...
The evidence for this chapter is limited. Its four entries rest on seven evidence items, two of them strong. Six come from research literature and one from a practitioner account. Two entries, \texttt{audit-human-gates-for-effectiveness} and \texttt{align-accountability-with-actual-control}, have no strong supporting item.
...
An earlier exploratory range was superseded when a preregistered replication returned \texttt{Not\ identified}. The estimator targeted agent authorship beyond the trailer-marked floor and failed to identify that quantity under the specified design. Only the measured floor remains defensible.
...
\section{1. Test the autonomy transfer}\label{test-the-autonomy-transfer}
...
\section{2. Test whether provenance survives review and integration}\label{test-whether-provenance-survives-review-and-integration}
...
\section{3. Test the gate as a failure experiment}\label{test-the-gate-as-a-failure-experiment}
...
\section{4. Audit accountability in two passes}\label{audit-accountability-in-two-passes}
...
\section{graduate-autonomy-per-action-track-record}\label{graduate-autonomy-per-action-track-record}
...
\section{label-ai-provenance}\label{label-ai-provenance}
...
\section{audit-human-gates-for-effectiveness}\label{audit-human-gates-for-effectiveness}
...
\section{align-accountability-with-actual-control}\label{align-accountability-with-actual-control}
