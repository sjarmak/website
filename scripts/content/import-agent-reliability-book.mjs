...
export const CHAPTERS = [
  ...
  chapter(7, "ch07-isolation-injection-independent-verification.md", 3),
  chapter(8, "ch08-persistent-state-durable-workflows-idempotent-retries.md", 3),
  chapter(9, "ch09-replayable-traces-fault-injection-recovery.md", 3),
  chapter(10, "ch10-human-auditable-failure-analysis-taxonomy.md", 3),
  chapter(11, "ch11-measuring-designing-repository-retrieval.md", 4),
  chapter(12, "ch12-localization-funnels-repository-indexes-freshness-checks.md", 4),
  chapter(13, "ch13-usable-context-budgets-spec-restarts-file-output.md", 4),
  chapter(14, "ch14-cross-session-memory-raw-traces-compaction.md", 4),
  chapter(15, "ch15-verification-interfaces-risk-based-escalation.md", 5),
  chapter(16, "ch16-autonomy-provenance-gates-accountability.md", 5),
  chapter(17, "ch17-agent-topology-dynamic-task-allocation.md", 6),
  chapter(18, "ch18-cost-aware-fleet-scheduling-model-routing.md", 6),
  {
